...
use aoc_2023::input::get_input;
use aoc_2023::output::report;
...
pub fn detail() {
    let input = get_input().to_owned();
    {
        ...
        report("Part 1", result, Instant::now() - start_time);
    }
    {
        let start_time = Instant::now();
        let result = solve_part_2(&input);
        report("Part 2", result, Instant::now() - start_time);
    }
}
...
mod tests {
    ...
    fn part1_example() {
        const SAMPLE: &str = indoc! {"
            ...
            treb7uchet
        "};
        assert_eq!(solve_part_1(SAMPLE), 142);
    }
    ...
    fn part2_example() {
        const SAMPLE: &str = indoc! {"
            ...
            7pqrstsixteen
        "};
        assert_eq!(solve_part_2(SAMPLE), 281);
    }
}
